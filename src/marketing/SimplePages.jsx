...
// ────────── CashFlow Planner (product page selling the app) ──────────
export function CashFlowPlanner() {
  return (
    <>
      <PageMeta title="CashFlow Planner — the wealth platform that thinks alongside you" description="See everything you own. Know what to do next. Plan for any future. The CashFlow Planner app — AI-powered wealth management for Indian investors and global Indians." path="/wealthwise" />
      ...
      <Container max={1080}>
        ...
        <div style={{ overflowX: "auto", marginBottom: 48 }}>
          <table style={{ width: "100%", borderCollapse: "collapse", background: T.white, borderRadius: 12, overflow: "hidden", fontSize: 14 }}>
            <thead><tr style={{ background: T.navy, color: T.white }}>
              <th style={{ padding: 14, textAlign: "left" }}>Feature</th><th style={{ padding: 14 }}>Excel</th><th style={{ padding: 14 }}>Traditional adviser</th><th style={{ padding: 14 }}>Generic apps</th><th style={{ padding: 14, color: T.goldLight }}>CashFlow Planner</th>
            </tr></thead>
            <tbody>
              {[
        ...
        <div style={{ background: T.parchment, borderRadius: 18, padding: 32 }}>
          ...
          <p style={{ color: T.slate, lineHeight: 1.75, fontSize: 15, marginTop: 10 }}>I built CashFlow Planner because the planning tools I needed for myself didn't exist. The big names sell products; the small advisers don't scale. AI changes the math — a Claude-powered planner can give individualised analysis that used to take a senior planner two weeks. That's the product.</p>
    ...
    <>
      ...
      <Container>
        ...
        <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
          ...
          <a href="https://topmate.io/planmycashflows/" target="_blank" rel="noreferrer" style={btnGhost}>Talk to Ashish</a>
        </div>
      </Container>
    </>
  );
...
export function About() {
  return (
    <>
      <PageMeta title="About — PlanMyCashflows" description="Founded by Col (Retd.) Ashish Bhardwaj. Built for professionals, families and military officers who want clarity in their financial planning." path="/about" />
      <PageHero kicker="About us" title="Mission planning, applied to your money." lead="PlanMyCashflows is a wealth advisory practice built on military precision and modern AI. We help Indian HNIs, defence officers, NRIs and salaried professionals build wealth plans that actually hold up under pressure." />
      <Container>
        <h2 style={H2}>Founder</h2>
        <p style={P}>Col (Retd.) Ashish Bhardwaj spent over two decades in the Indian Army. He started PlanMyCashflows so the same precision that went into mission planning could go into civilian financial planning — especially for fellow officers transitioning out, for HNIs who deserve better than commission-led advice, and for professionals who don't have time to figure it all out.</p>
        <h2 style={H2}>Team</h2>
        ...
        <ul style={UL}>
          ...
          <li><strong>Contact:</strong> hello@planmycashflows.com</li>
...
export function Contact() {
  return (
    <>
      <PageMeta title="Contact PlanMyCashflows" description="Book a call with Col Ashish on Topmate, or send a message via the contact form. Email hello@planmycashflows.com." path="/contact" />
      ...
      <Container>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px,1fr))", gap: 24 }}>
          <div style={{ background: T.white, borderRadius: 16, padding: 24, border: `1px solid ${T.silver}30` }}>
            ...
            <a href="https://topmate.io/planmycashflows/" target="_blank" rel="noreferrer" style={{ ...btnGold, display: "inline-block", marginTop: 12, textDecoration: "none" }}>Book a session →</a>
          </div>
          <div style={{ background: T.white, borderRadius: 16, padding: 24, border: `1px solid ${T.silver}30` }}>
        ...
        <div style={{ marginTop: 32, padding: 24, borderRadius: 14, background: T.parchment, fontSize: 14, color: T.slate, lineHeight: 1.75 }}>
          📧 hello@planmycashflows.com · 🏢 Gurugram, Haryana, India · 💼 WhatsApp / LinkedIn via links in the footer.
        </div>
      </Container>
    </>
  );
...
export function Pricing() {
  return (
    <>
      <PageMeta title="Pricing — CashFlow Planner" description="Free, Premium (₹999/mo or ₹9,999/yr), HNI (₹49,999/yr), Enterprise. Transparent pricing with a 14-day premium trial." path="/pricing" />
...
const LEGAL_PAGES = {
  privacy: {
    ...
    body: [
      ...
      ["Why we collect it", "To deliver the requested service (the AI Wealth Planner, the CashFlow Planner app), to communicate with you, and to improve our offering. We do not sell personal data to third parties."],
      ...
      ["Your rights under DPDP", "You can access, correct, withdraw consent, or request erasure of your personal data at any time by emailing hello@planmycashflows.com."],
      ["Retention", "We retain data only as long as needed for the stated purpose and applicable law."],
      ["Contact", "Data Protection Officer: hello@planmycashflows.com."],
    ],
  },
  terms: {
    title: "Terms of Service", lead: "The rules of the road for using planmycashflows.com and the CashFlow Planner app.",
    body: [
      ["Acceptance", "By using this site you agree to these terms. If you don't agree, please don't use the service."],
      ["Educational use only", "Content on this site and in the CashFlow Planner app is for educational and planning purposes. It is not personalised investment advice. Consult a SEBI-registered adviser before acting."],
  ...
  disclaimers: {
    ...
    body: [
      ["Not investment advice", "PlanMyCashflows is not a SEBI-registered investment adviser at the time of writing. Content is educational only."],
  ...
  "sebi-compliance": {
    ...
    body: [
      ...
      ["Conflicts of interest", "We do not earn commissions from any product distributor. The CashFlow Planner app is the only paid service we offer."],
  ...
  "grievance-redressal": {
    title: "Grievance Redressal", lead: "How to raise a concern with PlanMyCashflows — and what happens next.",
    body: [
      ["Step 1 — Direct to us", "Email grievance@planmycashflows.com or hello@planmycashflows.com with a description of the issue. We acknowledge within 24 hours and aim to resolve within 7 working days."],
