...
export function BlogIndex() {
  ...
  return (
    <>
      <PageMeta title="Blog — PlanMyCashflows" description="Sharp writing on Indian wealth: investing, planning, tax, NRI, defence, markets and the tools that matter." path="/blog" />
...
export function BlogCategory() {
  ...
  return (
    <>
      <PageMeta title={`${c} posts — PlanMyCashflows Blog`} description={`All PlanMyCashflows blog posts in the ${c} category.`} path={`/blog/category/${category}`} />
      <section style={{ background: `linear-gradient(180deg, ${T.parchment}, ${T.cream})`, padding: "56px 24px 24px" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center" }}>
