...
export function ResourcesHub() {
  return (
    <>
      <PageMeta title="Resources — PlanMyCashflows" description="Free calculators, a finance glossary, and downloadable PDFs to help you think clearly about wealth." path="/resources" />
...
export function Glossary() {
  ...
  return (
    <>
      <PageMeta title="Finance Glossary — PlanMyCashflows" description="Plain-English definitions of 35+ Indian and global finance terms — AIF, PMS, ELSS, LTCG, DTAA, OROP and more." path="/resources/glossary" />
...
export function Downloads() {
  return (
    <>
      <PageMeta title="Free Downloads — PlanMyCashflows" description="Free PDF cheat-sheets for professionals, defence officers, NRIs and HNIs. Sign up to receive any of them." path="/resources/downloads" />
